package com.xtan.component.dialog
...
import com.xtan.component.dialog.extensions.AnimatorListenerEx
import com.xtan.component.dialog.extensions.UtilsExtension.Companion.getScreenHeight
import com.xtan.component.dialog.extensions.UtilsExtension.Companion.getScreenHeightOverStatusBar
import com.xtan.component.dialog.extensions.UtilsExtension.Companion.getScreenWidth
import com.xtan.component.dialog.listener.OnKeyListener
import com.xtan.component.dialog.other.DialogGravity
import com.xtan.component.dialog.other.DialogInitMode
...
open class CustomDialog : DialogFragment() {
    ...
    fun setDialogOptions(dialogOptions: DialogOptions): CustomDialog {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //如果是继承了CustomDialog，那么就会重写extendsOptions()方法
     ...
     * 数据绑定到视图/视图控件监听等
     */
    private fun convertView(holder: ViewHolder, dialog: CustomDialog) {
     ...
     */
    private fun dataConvertView(dialogBinding: Any, dialog: CustomDialog) {
        dialogOptions.dataConvertListener?.convertView(dialogBinding, dialog)
    }

    /**
     * 当继承CustomDialog时，需要重写该方法，详见AAA
     */
     ...
     * @param manager
     */
    fun showOnWindow(manager: FragmentManager): CustomDialog {
        myIsShow = true
        dialogOptions.apply {
     ...
     */
    fun showOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity): CustomDialog {
        myIsShow = true
        dialogOptions.apply {
     ...
     */
    fun showOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle): CustomDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
     ...
     * @param tag
     */
    fun showOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle, tag: String?): CustomDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
            this.animStyle = newAnim
     ...
     * @param tag
     */
    fun showNowOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle, tag: String?): CustomDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
            this.animStyle = newAnim
     ...
     * @param view 被依赖的view
     */
    fun showOnView(manager: FragmentManager, view: View): CustomDialog {
        myIsShow = true
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView): CustomDialog {
        myIsShow = true
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView, @StyleRes newAnim: Int? = dialogOptions.animStyle): CustomDialog {
        myIsShow = true
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView, @StyleRes newAnim: Int? = dialogOptions.animStyle, offsetX: Int = dialogOptions.offsetX, offsetY: Int = dialogOptions.offsetY): CustomDialog {
        myIsShow = true
